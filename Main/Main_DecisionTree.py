...
from Src.DecisionTree import model_decision_tree;
...
# save predictions
test_predictions_path = 'Results/predictions_DecisionTree.csv'

sj_train, iq_train = preprocess_data_pca(train_features_path, labels_path=train_labels_path)

sj_best_model = model_decision_tree(sj_train)
iq_best_model = model_decision_tree(iq_train)
